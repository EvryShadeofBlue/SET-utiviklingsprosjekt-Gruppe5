...
public class OpprettMånedligAvtaleFeilTest {
    @Mock
    ...
    @Test
    @DisplayName("Feil ved manglende dato for månedlig avtale")
    public void feilManglendeStartDato() {
        //Arrange
        LocalDateTime sluttdato = LocalDateTime.of(2024, 11, 30, 23, 59);
        Avtale avtale = new Avtale(null, "Månedlig besøk fra hjemmetjenesten", "månedlig", sluttdato, mockParorende, mockPleietrengende);
    ...
    @Test
    @DisplayName("Feil ved manglende beskrivelse for månedlig avtale")
    public void feilManglendeBeskrivelse() {
        // Arrange
        LocalDateTime dato = LocalDateTime.of(2024, 11, 1, 9, 0);
        LocalDateTime sluttDato = LocalDateTime.of(2025, 2, 2, 9, 0);
        Avtale avtale = new Avtale(dato, null, "månedlig", sluttDato, mockParorende, mockPleietrengende);
    ...
    public void feilSluttdatoFørDato() {
        // Arrange
        LocalDateTime dato = LocalDateTime.of(2025, 1, 2, 9, 0);
        LocalDateTime sluttDato = LocalDateTime.of(2024, 11, 1, 9, 0);
        Avtale avtale = new Avtale(dato, "Månedlig legesjekk", "månedlig", sluttDato, mockParorende, mockPleietrengende);
