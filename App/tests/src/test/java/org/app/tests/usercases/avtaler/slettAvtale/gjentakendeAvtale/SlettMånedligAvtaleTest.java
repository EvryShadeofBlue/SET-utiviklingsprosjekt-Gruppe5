...
public class SlettMånedligAvtaleTest {
    @Mock
    ...
    @Test
    @DisplayName("Sletting av en månedlig gjentakende avtale skal lykkes")
    public void slettManedligGjentakendeAvtale() {
        // Arrange
        int avtaleId = 3;
        LocalDateTime dato = LocalDateTime.of(2024, 11, 18, 12, 0);
        LocalDateTime sluttdato = dato.plusMonths(3);
        Avtale avtale = new Avtale(avtaleId, dato, "Månedlig møte", "månedlig", sluttdato, mockParorende, mockPleietrengende);
