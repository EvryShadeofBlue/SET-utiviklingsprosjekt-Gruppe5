...
public class OpprettUkentligAvtaleTest {
    @Mock
    ...
    @Test
    @DisplayName("Oppretter ukentlige avtaler")
    public void opprettUkentligeAvtaler() {
        //Arrange
        LocalDateTime dato = LocalDateTime.of(2024, 11, 1, 9, 0);
        LocalDateTime sluttDato = LocalDateTime.of(2024, 11, 21, 23, 59);
        Avtale avtale = new Avtale(dato, "Ukentlig oppfølging", "ukentlig", sluttDato, mockParorende, mockPleietrengende);
