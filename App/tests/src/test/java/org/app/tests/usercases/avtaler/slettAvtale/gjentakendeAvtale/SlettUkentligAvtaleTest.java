...
public class SlettUkentligAvtaleTest {
    @Mock
    ...
    @Test
    @DisplayName("Sletting av en ukentlig gjentakende avtale skal lykkes")
    public void slettUkentligGjentakendeAvtale() {
        // Arrange
        int avtaleId = 2;
        LocalDateTime dato = LocalDateTime.of(2024, 11, 18, 12, 0);
        LocalDateTime sluttdato = dato.plusWeeks(4);
        Avtale avtale = new Avtale(avtaleId, dato, "Ukentlig møte", "ukentlig", sluttdato, mockParorende, mockPleietrengende);
